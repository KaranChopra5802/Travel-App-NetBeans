...
public class insertBangalore extends javax.swing.JFrame {
    ...
    String namePass;
    int id;
    public insertBangalore(String str,int id1) {
        initComponents();
        namePass = str;
        jLabel7.setText(str);
        id=id1;
    ...
    private void initComponents() {
        ...
        getContentPane().add(jLabel8, new org.netbeans.lib.awtextra.AbsoluteConstraints(371, 20, -1, -1));
        getContentPane().add(jLabel7, new org.netbeans.lib.awtextra.AbsoluteConstraints(451, 20, 57, 14));
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        try 
        {
            ...
            Bangalore mf = new Bangalore(namePass);
